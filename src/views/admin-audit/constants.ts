...
export const AUDIT_ACTION_LABEL: Record<AuditAction, string> = {
	...
	[AuditAction.TEAM_MEMBER_UPDATED]: 'Изменён участник',
	[AuditAction.TEAM_CREATED]: 'Создание команды',
	[AuditAction.TEAM_UPDATED]: 'Изменение команды',
	[AuditAction.TEAM_DELETED]: 'Удаление команды',
...
export const AUDIT_ACTION_COLOR: Record<AuditAction, string> = {
	...
	[AuditAction.TEAM_MEMBER_UPDATED]: 'sky',
	[AuditAction.TEAM_CREATED]: 'mint',
	[AuditAction.TEAM_UPDATED]: 'sky',
	[AuditAction.TEAM_DELETED]: 'danger',
